        ...
        <div className="grid grid-cols-12 h-[750px]">
          ...
          <div className="col-span-6 border rounded-r-2xl px-5 pt-[90px]">
            <form onSubmit={handleContact} className="">
              <div className="">
                <div>
                  <h1 className="text-[30px] mb-2">Get in touch with us to plan your next transaction</h1>
                  <p className='text-[#696969] mb-10'>Our experts and developers would love to contribute their expertise and insights and help you today.</p>
                </div>
                <div className="flex gap-3">
                    <div className='w-full'>
                        <h2 className='text-[#7a7a7a] text-[13px] mb-1'>First name*</h2>
                        <input
                    ...
                    <div className='w-full'>
                        <h2 className='text-[#7a7a7a] text-[13px] mb-1'>Last name*</h2>
                        <input
                            className="pl-4 text-[14px] outline-none rounded h-[40px] bg-[#F8F9FA] w-full"
                            type="email"
                ...
                <div className="flex gap-3 mt-5">
                    <div className='w-full'>
                        ...
                        <textarea placeholder='Message' className='bg-[#F8F9FA] resize-none w-full outline-none p-3 text-[14px]' name="" id="" cols="30" rows="5"></textarea>
                    </div>
                </div>
                <button className="w-full h-[45px] border bg-[#A62F03] text-white rounded mt-3">
                    Send Email
                </button>
              </div>
            </form>
